...
// File RoleplayRealism.cs, copied unchanged for iOS except lines marked MOBILE. 1 [Invoke] attribute(s) removed: MobilePortedMods calls Init when the mod entry is enabled
