...
// File BLBSkybox.cs, copied unchanged for iOS except lines marked MOBILE.
...
void UpdateWorldTime() {
    ...
    private static BLBSkyboxSetting ProcessSkyboxSetting(string data) {
        ...
        #else
            TopCloudsTexture = LoadPresetTexture(Instance.presetMod, Mod, skyboxSetting.TopClouds.CloudsTextureFile);   // MOBILE
            TopCloudsNormalTexture = LoadPresetTexture(Instance.presetMod, Mod, skyboxSetting.TopClouds.CloudsNormalTextureFile);   // MOBILE
            
            BottomCloudsTexture = LoadPresetTexture(Instance.presetMod, Mod, skyboxSetting.BottomClouds.CloudsTextureFile);   // MOBILE
            BottomCloudsNormalTexture = LoadPresetTexture(Instance.presetMod, Mod, skyboxSetting.BottomClouds.CloudsNormalTextureFile);   // MOBILE

            StarsTexture = LoadPresetTexture(Instance.presetMod, Mod, skyboxSetting.Stars.StarsTextureFile);   // MOBILE
            StarsTwinkleTexture = LoadPresetTexture(Instance.presetMod, Mod, skyboxSetting.Stars.StarsTwinkleTextureFile);   // MOBILE
            TwinkleTexture = LoadPresetTexture(Instance.presetMod, Mod, skyboxSetting.Stars.TwinkleTextureFile);   // MOBILE

            MoonTexture = LoadPresetTexture(Instance.presetMod, Mod, skyboxSetting.Masser.MoonTextureFile);   // MOBILE
            SecundaTexture = LoadPresetTexture(Instance.presetMod, Mod, skyboxSetting.Secunda.MoonTextureFile);   // MOBILE
        #endif
