...
// File BetterAmbience/CameraShake/CameraShaker.cs, copied for iOS except lines marked MOBILE.
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            for (int i = 0; i < cameraShakeInstances.Count; i++)
            {
                ...
                if (c.CurrentState == 3 && c.DeleteOnInactive) //3 = innactive
                {
                    cameraShakeInstances.RemoveAt(i);
                    i--;
                }
                else if (c.CurrentState != 3) //3 = innactive
                {
