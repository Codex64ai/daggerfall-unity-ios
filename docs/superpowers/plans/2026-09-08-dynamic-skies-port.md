...
- Verified on the simulator at 216052ab9; 9cd0a54b1 (empty-name early return) post-dates the run and is covered by a self-test only; night sky and the diagnostics line are device-checklist items.
